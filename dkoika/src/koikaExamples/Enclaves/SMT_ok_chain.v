...
End Smt_ok_chain.
Extraction "out_Enclaves/Smt_ok_chain.Core0.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_chain.Core0.file.
Extraction "out_Enclaves/Smt_ok_chain.Mem.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_chain.Mem.file.
Extraction "out_Enclaves/Smt_ok_chain.Core1.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_chain.Core1.file.
Extraction "out_Enclaves/Smt_ok_chain.SM.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_chain.SM.file.
...
End Smt_ok_SimChain.
Extraction "out_Enclaves/Smt_ok_SimChain.Mem0.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_SimChain.Mem0.file.
Extraction "out_Enclaves/Smt_ok_SimChain.Mem1.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_SimChain.Mem1.file.
Extraction "out_Enclaves/Smt_ok_SimChain.SM0.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_SimChain.SM0.file.
Extraction "out_Enclaves/Smt_ok_SimChain.SM1.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_SimChain.SM1.file.
