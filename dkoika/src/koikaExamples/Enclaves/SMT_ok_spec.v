...
Module Smt_ok_spec<: SymbSpec.SMT_Spec_sig External.EnclaveParams SecurityParams Symbspec.
  ...
  End Core1.
End Smt_ok_spec.
Extraction "out_Enclaves/Smt_ok_spec.Core0.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_spec.Core0.file.
Extraction "out_Enclaves/Smt_ok_spec.Core1.ml" SyntaxMacros.struct_sz Bits.vect_t Smt_ok_spec.Core1.file.
